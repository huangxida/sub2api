  ...
  admin: {
    ...
    groups: {
      ...
      openaiMessages: {
        ...
        forcedReasoningTitle: '强制思考强度',
        forcedReasoningLabel: '思考强度',
        forcedReasoningHint:
    ...
    usage: {
      ...
      detail: {
        ...
        copyPath: '复制路径',
        copyField: '复制 {field}',
        copyFieldJson: '复制 {field} 的 JSON',
        copyFieldSuccess: '{field} 已复制',
        copyJsonSuccess: '节点 JSON 已复制',
        copyPathSuccess: '节点路径已复制',
        copySuccess: '原文已复制',
        copyFailed: '复制失败',
        contentType: '内容类型',
        sizeBytes: '字节数',
    ...
    settings: {
      ...
      gatewayForwarding: {
        ...
        openaiUnknownModelFallback: 'OpenAI 未知模型兜底',
        openaiUnknownModelFallbackHint: '请求模型无法识别时改写为指定上游模型；这是请求前归一化，不是失败后的模型重试兜底。留空目标模型可禁用。',
        openaiUnknownModelFallbackModel: '兜底目标模型',
        openaiUnknownModelFallbackScope: '生效范围',
        openaiUnknownModelScopeOAuth: '仅 OAuth/Codex',
        openaiUnknownModelScopeAllOpenAI: '全部 OpenAI 账号',
