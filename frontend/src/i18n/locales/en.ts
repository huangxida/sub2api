  ...
  admin: {
    ...
    groups: {
      ...
      openaiMessages: {
        ...
        forcedReasoningTitle: 'Forced Reasoning Intensity',
        forcedReasoningLabel: 'Reasoning intensity',
        forcedReasoningHint:
    ...
    usage: {
      ...
      detail: {
        ...
        noDetail: 'Raw request/response detail was not captured for this record',
        requestTab: 'Request',
        ...
        responseBody: 'Response Body',
        noResponseHeaders: 'Response headers were not captured for this record',
        jsonView: 'JSON View',
        rawView: 'Raw Text',
        searchJson: 'Search JSON',
        searchText: 'Search raw text',
        ...
        copyFieldJson: 'Copy {field} JSON',
        copyFieldSuccess: '{field} copied',
        copyJsonSuccess: 'Node JSON copied',
        copyPathSuccess: 'Node path copied',
        copySuccess: 'Raw content copied',
        copyFailed: 'Failed to copy raw content',
        contentType: 'Content Type',
        sizeBytes: 'Bytes',
        complete: 'Complete',
        frameSelect: 'Response Frame',
        frameLabel: 'Frame {index}',
        prev: 'Previous',
        next: 'Next',
        noSearch: 'No search',
        noMatches: 'No matches',
        matchSummary: '{current} / {total}'
      },
    ...
    settings: {
      ...
      gatewayForwarding: {
        ...
        openaiUnknownModelFallback: 'OpenAI Unknown Model Fallback',
        openaiUnknownModelFallbackHint: 'Rewrite unrecognized request models to the configured upstream model before sending the request. This is not the failure-retry model fallback. Leave the target model empty to disable it.',
        openaiUnknownModelFallbackModel: 'Fallback target model',
        openaiUnknownModelFallbackScope: 'Scope',
        openaiUnknownModelScopeOAuth: 'OAuth/Codex only',
        openaiUnknownModelScopeAllOpenAI: 'All OpenAI accounts',
